...
class Counter implements Runnable {
		// This method increments runs variable first and then incrememts the balls variable
		...
		public void IncrementBallAfterRun() {
				// Since we're updating runs variable first, lock the Runs.class references first
