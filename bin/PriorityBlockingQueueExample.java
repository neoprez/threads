// Illustrates the use of PriorityBlokingQueue. In this case, if there is no element available in the priority queue
// the thread calling tak*( method will block (i.e., wait) until another thread inserts an element
				...
				new Thread() {
						public void run() {
								try {
										...
										// note that take() block, whereas remove() doesn't block
