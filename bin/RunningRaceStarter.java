...
// three runner threads to be ready to start in the start line of the race and once the counter reachers zero, all the three runners start running...
...
class RunningRaceStarter {
		public static void main(String[] args) throws InterruptedException {
				...
				while(countVal > 0) {
						...
						if(countVal == 1) {
								// once counter.countDown(); in the next statemt is called,
...
// this Runner class simulates a track runner in a 100-meter dash race. The runner waits until the count down timer gets to zero and then starts running.
		...
		public void run() {
				try {
					// wait for the timer count down to reach 0
						...
						System.err.println("intterupted -- can't start running the race");
				}
